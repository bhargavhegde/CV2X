...
//Commsignia specific functions
int asn1_integer_get_ui_ov(const ASN1Integer *r, uint32_t *pval);
...
int asn1_uper_decode_to_addr(void **pdata, const ASN1CType *p,
                            const uint8_t *buf, int buf_len, ASN1Error *err);
asn1_ssize_t asn1_uper_encode2(uint8_t **pbuf, const ASN1CType *p, const void *data,
                           ASN1Error *err);
int asn1_uper_encode2_ng(uint8_t **pbuf, const ASN1CType *p, const void *data,
                            ASN1Error *err, uint32_t* p_u32p_encoded_bits);
...
*/
int asn1_seq_add(const ASN1CType *p, size_t* count, void** list, void* data);
...
/**
    ...
    @return 0 in case of succes
*/
int asn1_seq_del(const ASN1CType *p, size_t* count, void** list, int index);
